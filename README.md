# 🚀 Samet Çolak | Dijital Portfolyo & Kişisel Web Platformu

[![Live Website](https://img.shields.io/badge/Live-sametcolak.com.tr-blue?style=for-the-badge&logo=google-chrome)](https://sametcolak.com.tr)
[![Tech Stack](https://img.shields.io/badge/Tech-HTML5%20%7C%20CSS3%20%7C%20JS-orange?style=for-the-badge)](https://github.com/samet-colak)
[![Hosting](https://img.shields.io/badge/Hosting-GitHub%20Pages-lightgrey?style=for-the-badge&logo=github)](https://pages.github.com/)
...
* **⚡ Yüksek Performans:** Saf (Vanilla) HTML, CSS ve JavaScript ile sıfır dış bağımlılık (zero-dependency) kullanılarak maksimum sayfa hızı hedeflenmiştir.
* **📱 Tam Duyarlı (Responsive) Tasarım:** Mobil cihazlardan geniş masaüstü ekranlara kadar kusursuz çalışan, esnek UI/UX kurgusu.
* **🔍 Gelişmiş SEO Optimizasyonu:** Özelleştirilmiş `sitemap.xml`, `robots.txt` entegrasyonları ve semantik HTML5 yapısı ile tam arama motoru uyumluluğu.
* **🔒 Güvenli & Hızlı Altyapı:** GitHub Pages üzerinde barındırılmakta olup, Cloudflare CDN ve Strict SSL/TLS şifreleme ile global ölçekte güçlendirilmiştir.
